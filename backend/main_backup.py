...
def extract_text_from_pdf(file_content: bytes) -> str:
    ...
    if not PDF_AVAILABLE:
        ...
        return "PDF extraction not available - missing PyPDF2/pypdf library"
    ...
    try:
        ...
        if not text.strip():
            return "No text could be extracted from this PDF. It might be image-based or encrypted."
...
Answer:"""
        ...
        # Fallback to direct OpenAI API call using new client
        try:
            ...
            return "OpenAI library not available for direct API calls."
